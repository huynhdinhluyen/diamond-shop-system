...
import { CircularProgress, Typography, Fade, Slide, Grow } from "@mui/material";
import {
  ShoppingCart,
  People,
  AttachMoney,
...
export default function Dashboard() {
  ...
  const fetchData = async (startDate, endDate) => {
    ...
    try {
      ...
      const data = await getDashboardData(formattedStartDate, formattedEndDate);
      ...
      {isLoading ? (
        ...
        <Fade in={!isLoading} timeout={500}>
          <div className="flex flex-col">
            <div className="font-bold font-sans text-3xl text-black mb-4">
              TỔNG QUAN
            </div>
            ...
            <div className="mt-8 w-full flex md:flex-row flex-col justify-between">
              <Slide in={!isLoading} direction="right" timeout={1200}>
              ...
              <Slide in={!isLoading} direction="left" timeout={1200}>
